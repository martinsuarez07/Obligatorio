...
using System.Threading.Tasks;
    ...
    namespace Dominio
    {
        public class Vuelo
        {
            ...
            public List<DateTime> ObtenerProximasFechasDisponibles(int cantidadDias = 30)
            {
                ...
                {
                    DateTime posibleFecha = hoy.AddDays(i);
                    if (contieneFrecuencia(posibleFecha.DayOfWeek))
                    {
